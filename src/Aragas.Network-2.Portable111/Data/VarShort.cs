...
namespace Aragas.Network.Data
{
    ...
    public readonly struct VarShort : IEquatable<VarShort>
    {
        ...
        public static byte[] Encode(in VarShort value) => Variant.Encode(value._value);
        public static int Encode(in VarShort value, byte[] buffer, int offset)
        {
            var encoded = value.Encode();
            Buffer.BlockCopy(encoded, 0, buffer, offset, encoded.Length);
            return encoded.Length;
        }
        public static int Encode(in VarShort value, Stream stream)
        {
            var encoded = value.Encode();
        ...
        public static implicit operator ushort(in VarShort value) => value._value;
        public static implicit operator uint(in VarShort value) => value._value;
        public static implicit operator ulong(in VarShort value) => value._value;
        public static implicit operator VarShort(Enum value) => new VarShort(Convert.ToUInt16(value));


        public static bool operator !=(in VarShort a, in VarShort b) => !a.Equals(b);
        public static bool operator ==(in VarShort a, in VarShort b) => a.Equals(b);
